...
from .config import (
    styles, ACCENT_TEAL, TABLE_HEADER_BG, ALT_ROW_BG, DIVIDER_COLOR,
)
...
def build_comparison_table():
    ...
    rows = [
        ...
        [cell("Agent Skills (estandar abierto agentskills.io)"),
         cell(no_cover),
         cell("agentskills.io + Anthropic Academy + awesome-agent-skills + skillkit")],
        ...
        [cell("LLMs locales: fine-tuning, Ollama, open-weight"),
         cell(no_cover),
         cell("Unsloth + HF TRL + Ollama + Decodingml")],
        [cell("Multi-agente (CrewAI, AG2)"),
         cell("Cubre"),
         cell("DeepLearning.AI + docs oficiales")],
        [cell("Multimodal AI"),
         cell("Cubre"),
         cell("DeepLearning.AI short courses")],
        [cell("Deploy multi-cloud (AWS, Railway, Fly.io, etc.)"),
         cell("Parcial (Gradio, Flask)"),
         cell("Advent of Agents + AWS + Railway/Render/Fly.io/DO")],
        [cell("Superagentes personales (OpenClaw, MaxClaw)"),
         cell(no_cover),
         cell("OpenClaw + MaxClaw + NemoClaw + guias")],
    ]
    ...
    elements = [
        ...
        HRFlowable(
            ...
            color=ACCENT_TEAL, spaceAfter=8,
        ),
        Paragraph(
