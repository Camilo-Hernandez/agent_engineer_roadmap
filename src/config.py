...
CUSTOM_STYLES = [
    ("MT", dict(
        parent=styles["Title"], fontSize=26, leading=32,
        textColor=DARK_BG, spaceAfter=4, alignment=TA_CENTER,
        fontName="Helvetica-Bold",
    )),
    ("ST", dict(
        parent=styles["Normal"], fontSize=12, leading=16,
        textColor=MUTED_GRAY, spaceAfter=20, alignment=TA_CENTER,
        fontName="Helvetica",
    )),
    ("AU", dict(
        parent=styles["Normal"], fontSize=10, leading=14,
        textColor=DARK_TEXT, spaceAfter=2, alignment=TA_CENTER,
        fontName="Helvetica-Bold",
    )),
    ("AE", dict(
        parent=styles["Normal"], fontSize=9, leading=12,
        textColor=LINK_COLOR, spaceAfter=16, alignment=TA_CENTER,
        fontName="Helvetica",
    )),
    ("SH", dict(
        parent=styles["Heading1"], fontSize=16, leading=20,
        textColor=ACCENT_BLUE, spaceBefore=18, spaceAfter=8,
        fontName="Helvetica-Bold",
    )),
    ("BD", dict(
        parent=styles["Normal"], fontSize=10, leading=14,
    ...
    ("RT", dict(
        parent=styles["Normal"], fontSize=11, leading=15,
        textColor=DARK_BG, spaceBefore=6, spaceAfter=2,
        fontName="Helvetica-Bold",
    )),
    ("RD", dict(
        parent=styles["Normal"], fontSize=9.5, leading=13,
        textColor=MUTED_GRAY, spaceAfter=4, leftIndent=12,
        fontName="Helvetica",
    )),
    ("UL", dict(
        parent=styles["Normal"], fontSize=9, leading=12,
        textColor=LINK_COLOR, spaceAfter=8, leftIndent=12,
        fontName="Helvetica-Oblique",
    )),
    ("FN", dict(
        parent=styles["Normal"], fontSize=8, leading=10,
        textColor=MUTED_GRAY, alignment=TA_CENTER,
        fontName="Helvetica",
    )),
    ("CE", dict(
        parent=styles["Normal"], fontSize=8.5, leading=11,
    ...
    ("WN", dict(
        ...
        textColor=DARK_TEXT, spaceAfter=8, alignment=TA_JUSTIFY,
        fontName="Helvetica-Oblique", leftIndent=16, rightIndent=16,
        backColor=WARNING_BG, borderPadding=(8, 8, 8, 8),
    )),
]
