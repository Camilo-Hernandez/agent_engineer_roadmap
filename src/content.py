...
ROADMAP_CONTENT = RoadmapContent(
    title="Especialización Gratuita de Ingeniería de Sistemas Multiagente",
    ...
    intro_link_url="https://www.coursera.org/professional-certificates/ibm-rag-and-agentic-ai",
    intro_suffix=(
        "en Coursera. Estos recursos cubren el mismo conocimiento y más, "
        "provenientes directamente de los creadores de cada herramienta."
    ),
    author="Camilo Hernandez Ruiz - Ingeniero de Software y Automatizaciones",
    sections=(
        Section(
            title="Agent Skills (Estándar Abierto)",
            blocks=(
                SectionBlock(
                    "paragraph",
        ...
        Section(
            title="Fundamentos de Transformers y LLMs",
            blocks=(
                SectionBlock(
                    "paragraph",
        ...
        Section(
            title="LLMs Locales - Fine-Tuning y Deploy On-Premise",
            blocks=(
                SectionBlock(
                    "paragraph",
            ...
            resources=(
                Resource(
                    ...
                    ("https://youtu.be/W2xVSO6eUWY", "https://youtu.be/p2zZ6zuaCDM"),
                    ("GRATUITO", "OPEN SOURCE"),
                ),
                Resource(
        ...
        Section(
            title="Deploy a Produccion (Multi-Cloud)",
            blocks=(
                SectionBlock(
                    "paragraph",
        ...
        Section(
            ...
            blocks=(
                ...
                SectionBlock(
                    "heading", "n8n - Automatizacion low-code personal y empresarial"
                ),
                SectionBlock("heading", "Agentes tipo OpenClaw"),
            ),
            resources=(
                Resource(
    ...
    comparison=ComparisonTable(
        title="Tabla Resumen: Especializacion Paga de IBM vs. Ruta Gratuita",
        headers=("Tema", "IBM (Paga)", "Ruta Gratuita"),
        rows=(
            (
                "Fundamentos de Transformers y LLMs",
                "Parcial",
                "Hugging Face - LLM Course",
            ),
            (
                "Agent Skills (estandar abierto agentskills.io)",
                "NO cubre",
                "agentskills.io + Anthropic Academy + skills.sh + agentskill.sh",
            ),
            ("RAG pipelines, FAISS, vectores", "Cubre", "DeepLearning.AI - RAG course"),
            (
                "LangChain + LangGraph",
                "Cubre",
                "LangChain Academy + DeepLearning.AI (3 cursos)",
            ),
            (
                "MCP (Model Context Protocol)",
                "Cubre (FastMCP)",
                "HuggingFace + Anthropic + Microsoft",
            ),
            (
                "LLMs locales: fine-tuning, Ollama, open-weight",
                "NO cubre",
                "Unsloth + HF TRL + Ollama + Decoding AI Magazine",
            ),
            ("Multi-agente (CrewAI, AG2)", "Cubre", "DeepLearning.AI + docs oficiales"),
            ("Multimodal AI", "Cubre", "DeepLearning.AI short courses"),
            (
                "Deploy multi-cloud (AWS, Railway, Fly.io, etc.)",
                "Parcial (Gradio, Flask)",
                "Advent of Agents + AWS Lambda docs + Railway/Render/Fly.io/DO",
            ),
            (
                "Super 24/7 Agents",
                "NO cubre",
    ...
    closing_note=(
        "Ventaja de la ruta gratuita: La especializacion paga de IBM no cubre Agent Skills "
        "(estandar abierto), fine-tuning/deployment local de modelos open-weight, ni "
        "superagentes personales (OpenClaw/MaxClaw). Estos tres temas son criticos para "
...
def get_roadmap_content() -> RoadmapContent:
